...
> **Lưu ý key naming**: `template_data` dùng **camelCase** (`userName`, `eventCode`, ...). Các placeholder trong HTML dùng format chuẩn của gateway `%key%` (`%userName%`, `%eventCode%`), khớp thẳng với `template_data` key. Bảng dưới map rõ placeholder ↔ key. Khi tạo template thật trên gateway, đặt biến theo cột **`template_data` key**.
...
| `eventCode` | `%eventCode%` | string | mã thử thách (hiển thị trong `[%eventCode%]`) |
...
- Subject: `T-Fluencers | [%eventCode%] %eventName% đang nóng lên! 🔥 Cập nhật mới dành cho bạn`
        ...
        <tr>
          <td style="padding: 24px">
            <p
              ...
              "
            >
              T-Fluencers | [%eventCode%] %eventName% đang nóng lên! 🔥 Cập nhật mới
              dành cho bạn
            </p>
            <p
              style="
...
- Subject: `T-Fluencers | [%eventCode%] %eventName% đã đạt 95% ngân sách phí quảng cáo! ⚡`
        ...
        <tr>
          <td style="padding: 24px">
            <p
              ...
              "
            >
              T-Fluencers | [%eventCode%] %eventName% đã đạt 95% ngân sách phí quảng cáo!⚡
            </p>
            <p
              style="
                margin: 0 0 8px;
...
- Subject: `T-Fluencers | [%eventCode%] %eventName% đã chạm mốc 100%! 🎉`
        ...
        <tr>
          <td style="padding: 24px">
            <p
              ...
              "
            >
              T-Fluencers | [%eventCode%] <b>%eventName%</b> đã chạm mốc 100%! 🎉
            </p>
            <p
              style="
                margin: 0 0 8px;
...
- HTML threshold dùng bộ placeholder RIÊNG (struct `ThresholdTemplatePayload`), khác 3 template budget ở trên:
  ...
  | `%eventCode%` | mã thử thách (hiển thị trong `[%eventCode%]`) |
        ...
        <tr>
          <td style="padding: 24px">
            ...
            <p
              ...
              "
            >
              Chương trình <strong>[%eventCode%] %programName%</strong> đã đạt ngưỡng ngân sách mà bạn đã thiết lập.
            </p>
...
| **Subject hiện tại** | `[%company%] Bạn được mời tham gia hệ thống` |
...
| **Subject hiện tại** | `[%company%] Yêu cầu đặt lại mật khẩu` |
