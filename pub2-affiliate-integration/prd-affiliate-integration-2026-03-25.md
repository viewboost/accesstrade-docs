...
**Acceptance Criteria:**
- [ ] Admin có thể tạo affiliate campaign với các trường: partner (required), title, description, banner image, category, commission info, pub2_campaign_id, pub2_campaign_url, start_date, end_date
