...
### Mô hình hạ tầng + license
- **Hạ tầng AWS:** AT cung cấp theo cách chuẩn của các dự án khác đang chạy ở AT (Diso không phụ trách chi phí hosting)
- **Influence-meter license:** Gộp chung với T-Fluencers — phí tháng đã có trong license đó, không tính riêng cho dự án này
- **Vận hành hệ thống:** Tính chung vào scope vận hành dự án Ambassador, dự phòng tối thiểu 8h/vị trí cho việc xử lý phát sinh

### Tổng chi phí

| Khoản mục | Số tiền | Loại |
|---|---:|---|
| Chi phí khởi tạo MVP (build 4 tuần) | 80.000.000đ | One-time |
| Khởi tạo influence-meter (gộp chung với T-Fluencers) | 10.000.000đ | One-time |
| Phí tháng influence-meter (gộp T-Fluencers, max 10.000 hồ sơ) | 0đ | Đã có trong license T-Fluencers |
| Vận hành hệ thống (8h/vị trí dự phòng) | 0đ | Đã có trong scope Ambassador |
| **TỔNG khởi tạo** | **90.000.000đ** | |

> **Giảm giá khởi tạo:** Effort thực tế theo tasks.csv là 254h × rate role = $3.648 ≈ **94.848.000đ** (rate 26.000 VND/USD). Báo giá AT phần khởi tạo MVP **80.000.000đ** → Diso giảm **14.848.000đ (~15,7%)** để build relationship dài hạn.
>
> **Ghi chú:**
> - Influence-meter license gộp chung T-Fluencers, **không tính phí tháng riêng** cho dự án MVP này. Quota tổng tối đa 10.000 hồ sơ — vượt quota thì báo giá riêng.
> - Vận hành dự án không phát sinh phí riêng — Diso đã dự phòng tối thiểu 8h/vị trí (PM + Dev + QC) trong scope vận hành Ambassador để xử lý vấn đề từ MVP này.
