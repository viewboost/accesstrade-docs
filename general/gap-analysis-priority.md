...
| 32 ✅ | ~~**Mã nhân viên + binding partner** vCreator → Amb (full)~~ **ĐÃ XONG cho Ambassador (2026-09-04)**; vCr → TCB (extend) vẫn còn | 3-4 tuần | EmployeeRegistry 18 fields + match engine |
